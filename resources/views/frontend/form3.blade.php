...
<!-- Success Section -->
    <section class="success-section">
		...
		<div class="tab"><h3>Age</h3>
		  <p><input placeholder="Age" oninput="this.className = ''"></p>
		</div>

		<div class="tab"><h3>ITR</h3>
		  <p><input placeholder="ITR" oninput="this.className = ''"></p>
		</div>



		<div class="tab"><h3>SMOKER OR NON SMOKER</h3>
		<div class="row">

			<div class="col-md-3">
		        <div class="custom-control custom-radio image-checkbox">
		            <input type="radio" class="custom-control-input" id="ck2da" name="health_coverage" checked>
		            <label class="custom-control-label" for="ck2da">
		    ...
		    <div class="col-md-3">
		        <div class="custom-control custom-radio image-checkbox">
		            <input type="radio" class="custom-control-input" id="ck3da" name="health_coverage">
		            <label class="custom-control-label" for="ck3da">
		...
		<div class="tab"><h3>ANNUAL INCOME BRACKET</h3>
		  <p><input placeholder="Income" oninput="this.className = ''"></p>
		</div>

		<div class="tab"><h3>SUM INSURED REQUIRED</h3>
		  <p><input placeholder="Insured" oninput="this.className = ''"></p>
		</div>


		<div class="tab"><h3>POLICY PAYING TERM REQUIRED</h3>
		<div class="row">

			<div class="col-md-3">
		        <div class="custom-control custom-radio image-checkbox">
		            <input  type="radio" class="custom-control-input" id="a4" name="health_coverage" checked>
		    ...
		    <div class="col-md-3">
		        <div class="custom-control custom-radio image-checkbox">
		            <input  type="radio" class="custom-control-input" id="a5" name="health_coverage">
		    ...
		    <div class="col-md-3">
		        <div class="custom-control custom-radio image-checkbox">
		            <input  type="radio" class="custom-control-input" id="a6" name="health_coverage">
		        ...
		        <div class="custom-control custom-radio image-checkbox">
		            <input  type="radio" class="custom-control-input" id="a7" name="health_coverage">
		...
		<div class="tab"><h3>ANY PRE EXISTING DISEASE</h3>
		  <p><input placeholder="Disease" oninput="this.className = ''"></p>
		</div>
