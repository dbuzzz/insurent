            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('status', function($row){
                        ...
                        if ($row->active_status == 1) {
                           ...
                           $btn .= '<br><span class="badge badge-primary" style="cursor:pointer;" onclick="view('.$row->id.')">View</span>';
                          
                            return $btn;
                    })
                    ->rawColumns(['image','action','status','permission','info','info2','descr'])
                    ->make(true);
        }
    }//end of method
...
//         $src = "https://cdn.shopify.com/s/files/1/0265/4545/5207/products/kesa.jpg?v=1664287938";
// // $dest = asset('uploads').'/';
//         print_r(storage_path('app/public/upload.jpg'));
// // print_r(Storage::disk('public')->put('upload1.jpg', file_get_contents($src)));
// print_r(Sfile_get_contents($src));
// die;
