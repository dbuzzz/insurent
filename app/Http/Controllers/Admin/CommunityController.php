...
class CommunityController extends Controller
{
    public function index()
    {
      ...
      return view('admin.community',$data);
    }//end of method
    ...
    public function save(Request $request){
        ...
        if($validator->passes()) {
            ...
            if (!empty($id)) {
                ...
                $row = Community::where('id',$id)->update($formdata);
                $msg = 'Data Updated';
            }else{
                $formdata['added_by'] = Auth::user()->id;
                $row = Community::insertGetId($formdata);
                $msg = 'Data Inserted';
    ...
    public function show(Request $request){
        if ($request->ajax()) {
            $data = Community::where(['is_deleted'=>0])->orderBy('id','DESC')->get();
    ...
    public function delete(Request $request){
        ...
        $row = Community::where('id',$request->id)->update($data);
