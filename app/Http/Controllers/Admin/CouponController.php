...
class CouponController extends Controller
{
    ...
    public function save(Request $request){
        ...
        if($validator->passes()) {
            ...
            $formdata['validity_from'] = date('Y-m-d',strtotime($request->validity_from));
            $formdata['validity_to'] = date('Y-m-d',strtotime($request->validity_to));
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('type', function($row){
                        ...
                        if ($row->value) {
                           $btn.= '<span class="badge badge-info">'.$row->value.'</span>';
                        }
                    ...
                    ->rawColumns(['type','validity','action','status'])
                    ->make(true);
        }
    }//end of method
